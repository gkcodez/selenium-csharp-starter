	...
	<div class="details">
		...
		<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="BUILDID" DataSourceID="BuildDetails" OnRowDataBound="GridView1_OnRowDataBound" OnRowCommand="GridView1_OnRowCommand" OnDataBound="OnDataBound" CssClass="text-center">
			<Columns>
				...
				<asp:BoundField DataField="EXECUTIONDATE" HeaderText="EXECUTION DATE" SortExpression="EXECUTIONDATE" ItemStyle-Width="20%" />
				<asp:BoundField DataField="EXECUTIONTIME" HeaderText="EXECUTION TIME" SortExpression="EXECUTIONTIME" ItemStyle-Width="20%" />
